...
class ParsianLogin
{
    ...
    public function login()
    {
        ...
        $loginData3 = $this->loginData2;
        $loginData3['otpPassword'] = readline('Enter the SMS:');
        $loginData3['challengeKey'] = $login2Response["body"];

        $login3Response = $this->curlRequest($loginUrl, http_build_query($loginData3));
        writeOnFile('responses/login3Response.html', $login3Response["body"]);
