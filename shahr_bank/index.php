...
try {
    ...
    if ($captchaRawImage != '') {
        ...
        $code = curl_getinfo($ch, CURLINFO_HTTP_CODE);
        writeOnFile('response/loginResponse.html', $code . $loginResponse);
        ...
        $code = curl_getinfo($ch, CURLINFO_HTTP_CODE);
        writeOnFile('response/loginResponse2.html', $code . $loginResponse2);
        ...
        $code = curl_getinfo($ch, CURLINFO_HTTP_CODE);
        writeOnFile('response/checkUsernameResponse.html', $code . $checkUsernameResponse);
        ...
        $code = curl_getinfo($ch, CURLINFO_HTTP_CODE);
        writeOnFile('response/checkPasswordResponse.html', $code . $checkPasswordResponse);
        ...
        $code = curl_getinfo($ch, CURLINFO_HTTP_CODE);
        writeOnFile('response/completeLoginResponse.html', $code . $completeLoginResponse);
        ...
        $code = curl_getinfo($ch, CURLINFO_HTTP_CODE);
        writeOnFile('response/homePageHtml.html', $code . $homePageHtml);
        ...
        $code = curl_getinfo($ch, CURLINFO_HTTP_CODE);
        writeOnFile('response/selectPageHtml.html', $code . $selectPageHtml);
        ...
        $code = curl_getinfo($ch, CURLINFO_HTTP_CODE);
        writeOnFile('response/depositeShowHtml.html', $code . $depositeShowHtml);
