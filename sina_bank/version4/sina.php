...
class Sina extends banking{
    ...
    public function autoSigninStep1()
    {
        ...
        file_put_contents(ROOT_PATH.'dumps/1-sina-getSigninPage.txt',var_export($signinPage,true));
        ...
        file_put_contents(ROOT_PATH.'dumps/1-sina-getDataFromSigninPage.txt',var_export($loginData,true));
        ...
        file_put_contents(ROOT_PATH.'dumps/1-sina-getDataFromSigninPage.txt',"\n\n\n".var_export($loginData,true),FILE_APPEND);
        $sendSMSResponse = $this->sendSMSCodeToUser($loginData);
        file_put_contents(ROOT_PATH.'dumps/1-sina-sendSMSCodeToUser.txt',var_export($sendSMSResponse,true));
        ...
        $this->loginData2["ticketLoginToken"] = getInputTag($sendSMSResponse["body"], '/<input type="hidden" name="ticketLoginToken" value=".*/');
        $this->loginData2["mobileNumber"] = getInputTag($sendSMSResponse["body"], '/<input type="hidden" class="" name="mobileNumber" id="mobileNumber" value=".*/');
    ...
    private function logStatements($datetime='null', $amount='null')
    {
        ...
        $depositShowToken = getInputTag($depositShowHtml["body"],'/<input type="hidden" name="depositShowToken" value=".*/');
        $stmtIdnote1 = getInputTag($depositShowHtml["body"],'/<input type="hidden" class="" name="stmtIdnote1" id="stmtIdnote1" value=".*/');
        $now = jdate('Y/m/d');
        $nowDate = "$now  -  23:59";
    ...
    public function twoPhaseLogin(array $twoPhaseData)
    {
        ...
        file_put_contents(ROOT_PATH.'dumps/1-sina-twoPhaseLogin.txt',var_export($res,true));
